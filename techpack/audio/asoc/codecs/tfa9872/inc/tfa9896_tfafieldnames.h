...
#define TFA9896_NAMETABLE static struct tfa_bf_name tfa9896_datasheet_names[]= {\
...
#define TFA9896_BITNAMETABLE static struct tfa_bf_name tfa9896_bit_names[]= {\
   ...
   { 0xe96, "reserve_reg_15_09"},    /* Spare control bits for future usage               , */\
...
#define TFA9896_IRQ_NAMETABLE static struct tfa_irq_name tfa9896_irq_names[]= {\
	{ 0, "VDDS"},\
	{ 1, "PLLS"},\
	{ 2, "DS"},\
	{ 3, "VDS"},\
