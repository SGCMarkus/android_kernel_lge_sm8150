...
#define TFA2_NAMETABLE static struct tfa_bf_name tfa2_datasheet_names[]= {\
...
#define TFA2_BITNAMETABLE static struct tfa_bf_name tfa2_bit_names[]= {\
...
#define TFA2_IRQ_NAMETABLE static struct tfa_irq_name tfa2_irq_names[]= {\
	{ 0, "STVDDS"},\
	{ 1, "STPLLS"},\
	{ 2, "STOTDS"},\
	{ 3, "STOVDS"},\
