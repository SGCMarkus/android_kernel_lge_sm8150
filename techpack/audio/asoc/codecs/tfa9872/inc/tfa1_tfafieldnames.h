...
#define TFA1_NAMETABLE static struct tfa_bf_name tfa1_datasheet_names[]= {\
...
#define TFA1_BITNAMETABLE static struct tfa_bf_name tfa1_bit_names[]= {\
...
#define TFA1_IRQ_NAMETABLE static struct tfa_irq_name tfa1_irq_names[]= {\
	{ 0, "VDDS"},\
	{ 1, "PLLS"},\
	{ 2, "DS"},\
	{ 3, "VDS"},\
