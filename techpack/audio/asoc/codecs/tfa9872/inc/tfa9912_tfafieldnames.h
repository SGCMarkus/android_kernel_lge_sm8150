 ...
 *  This file was generated automatically on 11/30/16 at 13:13:45. 
 *  Source file: TFA9912_N1A_I2C_regmap_V1.34.xlsx
 */
...
#define TFA9912_I2CVERSION    1.34
...
enum tfa9912_bf_enum_list {
    ...
    TFA9912_BF_REFCKXEXT= 0x0401,    /*!< PLL external ref clock                             */
    ...
    TFA9912_BF_SSRIGHTE= 0x0510,    /*!< Enable speaker path                                */
    ...
    TFA9912_BF_PDMSMUTE= 0x0da0,    /*!< Side tone soft mute                                */
    ...
    TFA9912_BF_DCMODSTAT= 0x1471,    /*!< DCDC mode status bits                              */
    ...
    TFA9912_BF_VDDP  = 0x1709,    /*!< IC VDDP voltage ( 1023*VDDP/12 V)                  */
    TFA9912_BF_DCILCF= 0x17a0,    /*!< DCDC current limiting                              */
    ...
    TFA9912_BF_TDMFSLN= 0x2073,    /*!< FS length (master mode only)                       */
    ...
    TFA9912_BF_TDMLE = 0x2310,    /*!< Control audio  left (channel in 1 )                */
    TFA9912_BF_TDMRE = 0x2320,    /*!< Control audio right (channel in 2 )                */
    ...
    TFA9912_BF_TDMISIO= 0x2461,    /*!< IO Current Sense                                   */
    TFA9912_BF_TDMVSIO= 0x2481,    /*!< IO voltage sense                                   */
    TFA9912_BF_TDMGOUT= 0x24a1,    /*!< IO gain out                                        */
    ...
    TFA9912_BF_TDMLS = 0x2643,    /*!< tdm slot for audio left (channel 1)                */
    TFA9912_BF_TDMRS = 0x2683,    /*!< tdm slot for audio right (channel 2)               */
    TFA9912_BF_TDMGOS= 0x26c3,    /*!< Slot Position of Current Sense Out                 */
    TFA9912_BF_TDMVSS= 0x2703,    /*!< Slot Position of Voltage sense                     */
    TFA9912_BF_TDMCSS= 0x2743,    /*!< Slot Position of GAIN out                          */
    ...
    TFA9912_BF_IPCLKOOR= 0x4df0,    /*!< Polarity flag_clk_out_of_range                     */
    ...
    TFA9912_BF_TDMDCG= 0x6123,    /*!< Attenuation TDM/DSP output (before interpolator)   */
    ...
    TFA9912_BF_DCDCEXT= 0x6630,    /*!< DCDC                                               */
    TFA9912_BF_TDMMAP= 0x6801,    /*!< tdm source mapping                                 */
    TFA9912_BF_TDMMAPASEL= 0x6821,    /*!< frame a selection                                  */
    TFA9912_BF_TDMMAPBSEL= 0x6841,    /*!< frame b selection                                  */
    ...
    TFA9912_BF_DCDCSEL= 0x70c1,    /*!< DCDC IIR input Selection                           */
    TFA9912_BF_DCPWM = 0x70f0,    /*!< DCDC PWM only mode                                 */
    TFA9912_BF_TIPLVL1= 0x7504,    /*!< Adaptive boost trip levels 1, effective only when boost_intelligent is set to 1 */
    TFA9912_BF_TIPLVL2= 0x7554,    /*!< Adaptive boost trip level 2, effective only when boost_intelligent is set to 1 */
    TFA9912_BF_TIPLVLT= 0x75a4,    /*!< Adaptive boost trip levels, effective only when boost_intelligent is set to 1 */
...
#define TFA9912_NAMETABLE static struct tfa_bf_name tfa9912_datasheet_names[]= {\
   ...
   { 0x401, "REFCKXEXT"},    /* PLL external ref clock                            , */\
   ...
   { 0x500, "SSLEFTE"},    /*                                                   , */\
   { 0x510, "SSRIGHTE"},    /* Enable speaker path                               , */\
   { 0x520, "VSLEFTE"},    /*                                                   , */\
   ...
   { 0x1471, "DCMODSTAT"},    /* DCDC mode status bits                             , */\
   ...
   { 0x1709, "VDDP"},    /* IC VDDP voltage ( 1023*VDDP/12 V)                 , */\
   { 0x17a0, "DCILCF"},    /* DCDC current limiting                             , */\
   ...
   { 0x2310, "TDMLE"},    /* Control audio  left (channel in 1 )               , */\
   { 0x2320, "TDMRE"},    /* Control audio right (channel in 2 )               , */\
   ...
   { 0x2461, "TDMISIO"},    /* IO Current Sense                                  , */\
   { 0x2481, "TDMVSIO"},    /* IO voltage sense                                  , */\
   { 0x24a1, "TDMGOUT"},    /* IO gain out                                       , */\
   ...
   { 0x2643, "TDMLS"},    /* tdm slot for audio left (channel 1)               , */\
   { 0x2683, "TDMRS"},    /* tdm slot for audio right (channel 2)              , */\
   { 0x26c3, "TDMGOS"},    /* Slot Position of Current Sense Out                , */\
   { 0x2703, "TDMVSS"},    /* Slot Position of Voltage sense                    , */\
   { 0x2743, "TDMCSS"},    /* Slot Position of GAIN out                         , */\
   ...
   { 0x6123, "TDMDCG"},    /* Attenuation TDM/DSP output (before interpolator)  , */\
   ...
   { 0x6630, "DCDCEXT"},    /* DCDC                                              , */\
   { 0x6801, "TDMMAP"},    /* tdm source mapping                                , */\
   { 0x6821, "TDMMAPASEL"},    /* frame a selection                                 , */\
   { 0x6841, "TDMMAPBSEL"},    /* frame b selection                                 , */\
   ...
   { 0x70c1, "DCDCSEL"},    /* DCDC IIR input Selection                          , */\
   { 0x70f0, "DCPWM"},    /* DCDC PWM only mode                                , */\
   { 0x7504, "TIPLVL1"},    /* Adaptive boost trip levels 1, effective only when boost_intelligent is set to 1, */\
   { 0x7554, "TIPLVL2"},    /* Adaptive boost trip level 2, effective only when boost_intelligent is set to 1, */\
   { 0x75a4, "TIPLVLT"},    /* Adaptive boost trip levels, effective only when boost_intelligent is set to 1, */\
...
#define TFA9912_BITNAMETABLE static struct tfa_bf_name tfa9912_bit_names[]= {\
   ...
   { 0x1709, "vddp_adc"},    /* IC VDDP voltage ( 1023*VDDP/12 V)                 , */\
   { 0x17a0, "flag_bst_bstcur_cf"},    /* DCDC current limiting                             , */\
   ...
   { 0x6123, "ctrl_att"},    /* Attenuation TDM/DSP output (before interpolator)  , */\
   ...
   { 0xc1a0, "bg_filt_bypass_enbl"},    /* Enable control - I2C direct mode                  , */\
...
#define TFA9912_IRQ_NAMETABLE static struct tfa_irq_name tfa9912_irq_names[]= {\
	{ 0, "STVDDS"},\
	{ 1, "STPLLS"},\
	{ 2, "STOTDS"},\
	{ 3, "STOVDS"},\
