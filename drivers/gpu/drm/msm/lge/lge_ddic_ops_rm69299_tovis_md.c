...
struct rm69299c_iq_data {
	char mode[8];
	char data[32];
};

static struct rm69299c_iq_data rm69299c_color_space_value[7] = {
	{"def", {0x00, 0x0B, 0x80, 0x47, 0x00, 0x00, 0xED, 0x0E, 0x0F, 0x00, 0x8F, 0x0E, 0x77, 0x77, 0x77, 0x77, 0x77,
		 0x10, 0x79, 0x77, 0x08, 0x00, 0xF8, 0x80, 0xFF, 0x07, 0x00, 0x19, 0x60, 0x83, 0xFF, 0x07}},
	{"cin", {0x00, 0x0B, 0x80, 0x47, 0xBB, 0xDD, 0xDD, 0xDD, 0xDD, 0xDB, 0x00, 0x00, 0x77, 0x77, 0x77, 0x77, 0x77,
		 0x10, 0x7B, 0xB6, 0x0F, 0x92, 0x20, 0x80, 0xAC, 0xB7, 0x02, 0x00, 0xB8, 0x81, 0x6E, 0x07}},
	{"pho", {0x00, 0x0B, 0x80, 0x47, 0xBB, 0xDD, 0xDD, 0xDD, 0xDD, 0xDB, 0x00, 0x00, 0x77, 0x77, 0x77, 0x77, 0x77,
		 0x10, 0xDB, 0x27, 0x86, 0x87, 0xA0, 0x07, 0x35, 0x77, 0x02, 0x49, 0xF0, 0x02, 0xDD, 0x06}},
	{"web", {0x00, 0x0B, 0x80, 0x47, 0xBB, 0xDD, 0xDD, 0xDD, 0xDD, 0xDB, 0x00, 0x00, 0x77, 0x77, 0x77, 0x77, 0x77,
		 0x10, 0x1E, 0x56, 0x14, 0xA7, 0x20, 0x04, 0x60, 0x47, 0x03, 0x0E, 0x70, 0x06, 0xE0, 0x06}},
	{"spo", {0x00, 0x0B, 0x80, 0x47, 0x00, 0x00, 0x0D, 0x00, 0x00, 0x00, 0xEF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		 0x10, 0x43, 0x26, 0x09, 0x65, 0xE0, 0x80, 0xA0, 0xE7, 0x81, 0x18, 0xD0, 0x81, 0xFF, 0x07}},
	{"gam", {0x00, 0x0B, 0x80, 0x47, 0x22, 0x42, 0x44, 0x22, 0x22, 0x22, 0xFF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		 0x10, 0x97, 0x26, 0x09, 0x60, 0xE0, 0x80, 0xF9, 0xD7, 0x81, 0x18, 0xD0, 0x81, 0xFF, 0x07}},
	{"exp", {0x00, 0x0B, 0x80, 0x47, 0x00, 0x00, 0xED, 0x0E, 0x0F, 0x00, 0x8F, 0x0E, 0x77, 0x77, 0x77, 0x77, 0x77,
		 0x10, 0x79, 0x77, 0x08, 0x00, 0xF8, 0x80, 0xFF, 0x07, 0x00, 0x19, 0x60, 0x83, 0xFF, 0x07}},
};

static struct rm69299c_iq_data custom_rgb_value[5] = {
	{"preset0", {0x00, 0x0B, 0x80, 0x47, 0x00, 0x00, 0x0D, 0x00, 0x00, 0x00, 0xEF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0x59, 0x56, 0x09, 0x58, 0xE0, 0x80, 0xFF, 0xB7, 0x81, 0x17, 0xE0, 0x81, 0x50, 0x07}},
	{"preset1", {0x00, 0x0B, 0x80, 0x47, 0x00, 0x00, 0x0D, 0x00, 0x00, 0x00, 0xEF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0xD0, 0x36, 0x09, 0x5B, 0xF0, 0x80, 0xFF, 0xC7, 0x81, 0x18, 0xD0, 0x81, 0xBC, 0x07}},
	{"preset2", {0x00, 0x0B, 0x80, 0x47, 0x00, 0x00, 0x0D, 0x00, 0x00, 0x00, 0xEF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0xF0, 0x26, 0x09, 0x5C, 0xF0, 0x80, 0xFF, 0xC7, 0x81, 0x19, 0xD0, 0x81, 0xE3, 0x07}},
	{"preset3", {0x00, 0x0B, 0x80, 0x47, 0x00, 0x00, 0x0D, 0x00, 0x00, 0x00, 0xEF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0x1B, 0xE7, 0x08, 0x61, 0x00, 0x81, 0xA5, 0xD7, 0x81, 0x1A, 0xC0, 0x81, 0xFB, 0x07}},
	{"preset4", {0x00, 0x0B, 0x80, 0x47, 0x00, 0x00, 0x0D, 0x00, 0x00, 0x00, 0xEF, 0x0F, 0x77, 0x77, 0x77, 0x77, 0x77,
		     0x10, 0x21, 0xC7, 0x08, 0x64, 0x00, 0x81, 0x51, 0xE7, 0x81, 0x1B, 0xC0, 0x81, 0xF6, 0x07}},
};

static char saturation_lut[5][12] = {
	{0x00, 0x0B, 0x80, 0x47, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0x00, 0x00},
	{0x00, 0x0B, 0x80, 0x47, 0xEE, 0xDE, 0xDD, 0xEE, 0xEE, 0xEE, 0x00, 0x00},
	{0x00, 0x0B, 0x80, 0x47, 0x00, 0x00, 0x0D, 0x00, 0x00, 0x00, 0xEF, 0x0F},
	{0x00, 0x0B, 0x80, 0x47, 0x22, 0x42, 0x44, 0x22, 0x22, 0x22, 0xFF, 0x0F},
	{0x00, 0x0B, 0x80, 0x47, 0x44, 0x84, 0x88, 0x44, 0x44, 0x44, 0xFF, 0x0F},
};
...
static char trueview_lut[27][15] = {
	{0x10, 0xF0, 0x26, 0x09, 0x5C, 0xF0, 0x80, 0xFF, 0xC7, 0x81, 0x19, 0xD0, 0x81, 0xE3, 0x07},
	{0x10, 0x74, 0x07, 0x00, 0x20, 0x00, 0x00, 0xA8, 0xA7, 0x80, 0x00, 0x08, 0x00, 0xFF, 0x07},
	{0x10, 0xE7, 0x07, 0x00, 0x1B, 0x00, 0x00, 0x4D, 0x87, 0x80, 0x00, 0x08, 0x00, 0x71, 0x06},
	{0x10, 0xE8, 0x07, 0x00, 0x1A, 0x00, 0x00, 0x3E, 0x87, 0x80, 0x00, 0x08, 0x00, 0x53, 0x06},
	{0x10, 0xE8, 0x07, 0x00, 0x1A, 0x00, 0x00, 0x31, 0x87, 0x80, 0x00, 0x08, 0x00, 0x33, 0x06},
	{0x10, 0xE9, 0x07, 0x00, 0x1A, 0x00, 0x80, 0x22, 0x87, 0x80, 0x00, 0x00, 0x00, 0x19, 0x06},
	{0x10, 0xE9, 0x07, 0x00, 0x19, 0x00, 0x00, 0x1D, 0x87, 0x80, 0x00, 0x08, 0x00, 0x07, 0x06},
	{0x10, 0xEA, 0x07, 0x00, 0x19, 0x00, 0x00, 0x12, 0x77, 0x80, 0x00, 0x08, 0x00, 0xE4, 0x05},
	{0x10, 0xEA, 0x07, 0x00, 0x19, 0x00, 0x80, 0x09, 0x77, 0x80, 0x00, 0x08, 0x00, 0xD6, 0x05},
	{0x10, 0xEA, 0x07, 0x00, 0x19, 0x00, 0x00, 0xFC, 0x76, 0x80, 0x00, 0x08, 0x00, 0xBF, 0x05},
};
...
static void dump_cm_dummy_reg_value(struct dsi_panel *panel)
{
	int i = 0;
	char *payload = NULL;
	int length = sizeof(rm69299c_color_space_value[0].data)/sizeof(char);
...
static int update_color_table(struct dsi_panel *panel, int idx)
{
	int i = 0;
	char *payload = NULL;
	int length = sizeof(rm69299c_color_space_value[idx].data)/sizeof(char);
	...
	for (i = 0; i < length; i++) {
		...
		*(++payload) = rm69299c_color_space_value[idx].data[i];
	}
...
{
	int i = 0;
	int max_mode = sizeof(rm69299c_color_space_value)/sizeof(struct rm69299c_iq_data);

	panel->lge.color_manager_status = 0x01;

	for (i = 0; i < max_mode; i++) {
		if(!strncmp(mode, rm69299c_color_space_value[i].mode, 3)) {
...
static void true_view_mapper(struct dsi_panel *panel, int idx)
{
	...
	/* Trueview Control */
	length = sizeof(trueview_lut[idx])/sizeof(char);

	for (i = 0; i < length; i++) {
		payload = get_payload_addr(panel, LGE_DDIC_DSI_DISP_CM_COMMAND_DUMMY, CM_HUE_INDEX + i);
		*(++payload) = trueview_lut[idx][i];
	}
}
...
static void lge_set_true_view_rm69299c(struct dsi_panel *panel, bool send_cmd)
{
	...
	if (panel->lge.true_view_mode > 0){
		int idx_max = sizeof(trueview_lut)/sizeof(trueview_lut[0]);
		if (panel->lge.true_view_mode > (idx_max - 1))
		    panel->lge.true_view_mode = (idx_max - 1);
