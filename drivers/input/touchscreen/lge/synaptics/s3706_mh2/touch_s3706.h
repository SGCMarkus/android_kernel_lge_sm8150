...
#define LPWG_STATUS_LONGP_DOWN		(1 << 3)
#define LPWG_STATUS_LONGP_UP		(1 << 4)
#define LPWG_STATUS_ONETAP			(1 << 5)
#define LPWG_DATA_REG				(d->f51.dsc.data_base + 1)
#define LPWG_OVER_TAPCOUNT			(d->f51.dsc.data_base + 61)
...
/* fail reason buffer should be changed */
...
#define LPWG_FAIL_REASON_REALTIME_INT	(d->f51.dsc.data_base + 62)
/* F51_CUSTOM_CTRL06.00 (MultiTap Fail Real-Time Interrupt Enable) */
// check if this register is there
#define LPWG_FAIL_INT_ENABLE_REG		(d->f51.dsc.control_base + 8)

/* Swipe Data Reg */
#define SWIPE_START_X_REG		(d->f51.dsc.data_base + 63)
#define SWIPE_START_Y_REG		(d->f51.dsc.data_base + 65)
#define SWIPE_END_X_REG			(d->f51.dsc.data_base + 67)
#define SWIPE_END_Y_REG			(d->f51.dsc.data_base + 69)
#define SWIPE_TIME_REG			(d->f51.dsc.data_base + 71)
#define SWIPE_DIRECTION_REG		(d->f51.dsc.data_base + 73)

/* press gesture Data Reg */
#define LONGPRESS_X_REG			(d->f51.dsc.data_base + 86)
#define LONGPRESS_Y_REG			(d->f51.dsc.data_base + 88)
#define LONGPRESS_MINOR_REG		(d->f51.dsc.data_base + 90)
#define ONETAP_X_REG			(d->f51.dsc.data_base + 92)
#define ONETAP_Y_REG			(d->f51.dsc.data_base + 94)

/* Swipe Control Reg */
#define SWIPE_ENABLE_REG		(d->f12_reg.ctrl[76])

/* LPWG ABS Control Reg */
#define LPWG_ABS_ENABLE_REG			(d->f51.dsc.control_base + 29)
#define LPWG_ABS_ACTIVE_X1_REG		(d->f51.dsc.control_base + 30)
#define LPWG_ABS_ACTIVE_Y1_REG		(d->f51.dsc.control_base + 32)
#define LPWG_ABS_ACTIVE_X2_REG		(d->f51.dsc.control_base + 34)
#define LPWG_ABS_ACTIVE_Y2_REG		(d->f51.dsc.control_base + 36)

/* Press gesture Control Reg */
#define LPWG_LONGPRESS_ENABLE_REG		(d->f51.dsc.control_base + 38)
#define LPWG_LONGPRESS_ACTIVE_X1_REG	(d->f51.dsc.control_base + 39)
#define LPWG_LONGPRESS_ACTIVE_Y1_REG	(d->f51.dsc.control_base + 41)
#define LPWG_LONGPRESS_ACTIVE_X2_REG	(d->f51.dsc.control_base + 43)
#define LPWG_LONGPRESS_ACTIVE_Y2_REG	(d->f51.dsc.control_base + 45)
#define LPWG_LONGPRESS_MIN_PRESS_TIME	(d->f51.dsc.control_base + 47)
#define LPWG_LONGPRESS_MIN_CONTACT_SIZE	(d->f51.dsc.control_base + 48)
#define LPWG_LONGPRESS_TOUCH_SLOPE		(d->f51.dsc.control_base + 49)

#define SENSITIVE_MODE_ENABLE_REG	(d->f51.dsc.control_base + 51)

#define LPWG_ONETAP_ENABLE_REG		(d->f51.dsc.control_base + 53)
#define LPWG_ONETAP_ACTIVE_X1_REG	(d->f51.dsc.control_base + 54)
#define LPWG_ONETAP_ACTIVE_Y1_REG	(d->f51.dsc.control_base + 56)
#define LPWG_ONETAP_ACTIVE_X2_REG	(d->f51.dsc.control_base + 58)
#define LPWG_ONETAP_ACTIVE_Y2_REG	(d->f51.dsc.control_base + 60)
#define LPWG_ONETAP_TOUCH_SLOP		(d->f51.dsc.control_base + 62)
#define LPWG_ONETAP_PRESS_TIME		(d->f51.dsc.control_base + 63)
#define LPWG_ONETAP_INTR_DELAY_TIME	(d->f51.dsc.control_base + 64)

/* Grip Suppression Control Reg */
#define GRIP_SUPPRESSION_CTRL_REG	(d->f51.dsc.control_base + 13)
...
struct s3706_lpwg_longpress_ctrl {
	u8 enable;
	int touch_slop;
	int min_press_time;
...
struct s3706_data {
	...
	struct s3706_lpwg_longpress_ctrl lpwg_longpress;
	struct s3706_lpwg_onetap_ctrl lpwg_onetap;
