...
int Pm8150bSaveOutputData(const char *outputDataBuffer, int count)
{
    /* Check buffer size */
...
bool Pm8150bSendOutputData(void)
{
...
void Pm8150bResetOutputData(void)
{
    g_nOutputData = 0;
    g_bOutputDataBufferEmpty = 1;
}

bool Pm8150bIsOutputDataBufferEmpty(void)
{
