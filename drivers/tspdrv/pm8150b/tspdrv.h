...
/* Kernel Debug Macros */
#ifdef __KERNEL__
    asmlinkage void _Pm8150bDbgOut(int level, const char *format,...);
    asmlinkage void _Pm8150bDbgOutTemp(const char *format,...);
    asmlinkage void _Pm8150bDbgOutFatal(const char *format,...);
    asmlinkage void _Pm8150bDbgOutErr(const char *format,...);
    asmlinkage void _Pm8150bDbgOutWarn(const char *format,...);
    asmlinkage void _Pm8150bDbgOutInfo(const char *format,...);
    asmlinkage void _Pm8150bDbgOutVerbose(const char *format,...);
    asmlinkage void _Pm8150bDbgOutOverkill(const char *format,...);

    #define DbgOut(_x_)  _Pm8150bDbgOut _x_
    #define DbgOutTemp(_x_) _Pm8150bDbgOutTemp _x_
    #define DbgOutFatal(_x_) _Pm8150bDbgOutFatal _x_
    #define DbgOutErr(_x_) _Pm8150bDbgOutErr _x_
    #define DbgOutWarn(_x_) _Pm8150bDbgOutWarn _x_
    #define DbgOutInfo(_x_) _Pm8150bDbgOutInfo _x_
    #define DbgOutVerbose(_x_) _Pm8150bDbgOutVerbose _x_
    #define DbgOutOverkill(_x_) _Pm8150bDbgOutOverkill _x_
